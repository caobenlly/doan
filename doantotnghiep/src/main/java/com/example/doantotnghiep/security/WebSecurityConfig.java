...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception{
        httpSecurity
                ...
                .disable()
                .authorizeRequests()
                .antMatchers("/api/order","/api/thanhtoan", "/tai-khoan", "/tai-khoan/**", "/api/change-password", "/api/update-profile","/api/products/{id}/update-feedback-image","/admin/promotions/**").authenticated()
