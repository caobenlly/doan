*------------------------------------------------------------------------------
* BAI 4 - CHUONG TRINH XUAT DANH SACH TAI KHOAN CUA KHACH HANG
* Input  : Ma khach hang (nhap tren CRT)
* Output : VN.FULL.NAME, NATIONAL.ID, So tai khoan, WORKING.BALANCE,
*          ACCOUNT.OFFICER
...
*   CUSTOMER.ACCOUNT la concat file, khong can file layout
...
*   Buoc 2: Doc CUSTOMER.ACCOUNT theo ma khach hang
    R.CUST.ACCT = ''
    F.CA.ERR = ''
...
*           Buoc 3: Doc ACCOUNT de lay so du va account officer
            R.ACCOUNT = ''
            F.ACC.ERR = ''
